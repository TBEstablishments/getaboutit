...
2. **Game-owned color identity.** Every game has a sworn primary + secondary accent from the palette (see [§3](#3--per-game-accent-registry), the 37-row registry). The accent appears on home tile, in-cabinet bezel, Card top-3 display, OG card, achievement badge, and leaderboard rank when the player tops it. Color → game mapping develops over repeat plays.
...
| 13 | Memory | `#d100d1` magenta | `#ffd60a` yellow | Magenta card backs, gold match sparkle |
| 14 | Minesweeper | `#4361ee` blue | `#ef233c` red | Blue numbers, red flag/mine |
| 15 | Slide | `#00f5ff` cyan | `#ffd60a` yellow | Cyan numbered tiles, yellow when solved |
| 16 | Lights Out | `#ffd60a` yellow | `#3a0ca3` deep purple | Lit yellow vs off deep-purple, binary clarity |
| 17 | Words | `#06ffa5` teal | `#ffd60a` yellow | Wordle-callback: right-place teal, right-letter-wrong-place yellow |
| 18 | Sudoku | `#4361ee` blue | `#06ffa5` teal | Blue digits, teal solved-cell highlight |
| 19 | Dots | `#ff006e` pink | `#00f5ff` cyan | You vs AI — pink lines/boxes vs cyan |
| 20 | Pixel | full palette | `#ffffff` | Paint-by-numbers needs full palette by definition |
| 21 | Tic Tac Toe | `#00f5ff` cyan | `#ff006e` pink | Cyan X, pink O. Maximum chromatic. |
| 22 | Chess | `#4361ee` blue | `#ffd60a` gold | Royal blue board, gold king accent |
| 23 | Checkers | `#ef233c` red | `#4361ee` blue | Red vs blue checkers, gold crown on kings |
| 24 | Connect 4 | `#ffd60a` yellow | `#ef233c` red | Classic yellow + red discs |
| 25 | Battleship | `#4361ee` blue | `#ef233c` red | Blue sea grid, red hit |
| 26 | Go | `#ffd60a` yellow | `#ffffff` white | Honey-yellow board, white stones; bg reads as black |
| 27 | Backgammon | `#ff9500` orange | `#ef233c` red | Warm wood board, red checkers |
| 28 | Blackjack | `#06ffa5` teal | `#ffd60a` gold | Teal felt, gold chip on 21 |
| 29 | Poker | `#ffd60a` yellow | `#ef233c` red | High-stake gold chip + red felt accent |
| 30 | Solitaire | `#4361ee` blue | `#ef233c` red | Classic Windows-Solitaire blue callback, red suits |
| 31 | Hearts | `#ef233c` red | `#d100d1` magenta | The red-suit game, queen-of-spades magenta danger |
| 32 | Cribbage | `#06ffa5` teal | `#ffd60a` yellow | Teal pegboard, gold 29 |
| 33 | Spider | `#3a0ca3` deep purple | `#06ffa5` teal | Spidery purple, teal completed-suit stacks |
| 34 | Craps | `#ef233c` red | `#ffffff` white | Red felt, white dice/bones |
| 35 | Simon | 4-quadrant | `#ffffff` | Red / yellow / blue / teal quadrants + white flash |
| 36 | Reaction | `#ef233c` red | `#06ffa5` teal | Red GO signal, teal ready state |
| 37 | Type Race | `#06ffa5` teal | `#ef233c` red | Teal correct chars, red mistakes |
...
<g transform="translate(408, 388)" opacity="0.3"><circle cx="22" cy="22" r="20" fill="#3a3a4a"/><text x="22" y="28" text-anchor="middle" fill="#888888" font-family="ui-monospace, monospace" font-size="13" font-weight="700">37</text></g>
...
| `COMPLETIONIST` | tried all 37 games |
